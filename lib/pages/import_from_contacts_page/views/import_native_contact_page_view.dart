            ...
            child:
              ...
              builder: (context, state) {
                if (state is NativeContactLoadingState) {
                  ...
                  return Text(state.errorMessage).padXXDefault;
